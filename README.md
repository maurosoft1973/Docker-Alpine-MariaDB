...
##### MariaDB Version 10.6.12-r0 (Released 2023-02-07 12:50:46)
...
* ```:3.17.3-10.6.12-r0``` 3.17.3-10.6.12-r0 branch based (Automatic Architecture Selection)
* ```:3.17.3-10.6.12-r0-aarch64```   3.17.3 64 bit ARM
* ```:3.17.3-10.6.12-r0-armhf```     3.17.3 32 bit ARM v6
* ```:3.17.3-10.6.12-r0-armv7```     3.17.3 32 bit ARM v7
* ```:3.17.3-10.6.12-r0-ppc64le```   3.17.3 64 bit PowerPC
* ```:3.17.3-10.6.12-r0-x86```       3.17.3 32 bit Intel/AMD
* ```:3.17.3-10.6.12-r0-x86_64```    3.17.3 64 bit Intel/AMD
...
***
###### Last Update 21.05.2023 17:08:38
