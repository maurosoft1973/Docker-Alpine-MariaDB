...
##### Alpine Version 3.13.4 (Released Feb Mar 31 2021)
...
* ```:3.13.4-10.5.15-r0``` 3.13.4-10.5.15-r0 branch based (Automatic Architecture Selection)
* ```:3.13.4-10.5.15-r0-aarch64```   3.13.4 64 bit ARM
* ```:3.13.4-10.5.15-r0-armhf```     3.13.4 32 bit ARM v6
* ```:3.13.4-10.5.15-r0-armv7```     3.13.4 32 bit ARM v7
* ```:3.13.4-10.5.15-r0-ppc64le```   3.13.4 64 bit PowerPC
* ```:3.13.4-10.5.15-r0-x86```       3.13.4 32 bit Intel/AMD
* ```:3.13.4-10.5.15-r0-x86_64```    3.13.4 64 bit Intel/AMD
...
***
###### Last Update 21.03.2022 09:21:43
