...
##### Alpine Version 3.17.2 (Released Feb Feb 10 2023)
...
* ```:3.17.2-10.6.12-r0``` 3.17.2-10.6.12-r0 branch based (Automatic Architecture Selection)
* ```:3.17.2-10.6.12-r0-aarch64```   3.17.2 64 bit ARM
* ```:3.17.2-10.6.12-r0-armhf```     3.17.2 32 bit ARM v6
* ```:3.17.2-10.6.12-r0-armv7```     3.17.2 32 bit ARM v7
* ```:3.17.2-10.6.12-r0-ppc64le```   3.17.2 64 bit PowerPC
* ```:3.17.2-10.6.12-r0-x86```       3.17.2 32 bit Intel/AMD
* ```:3.17.2-10.6.12-r0-x86_64```    3.17.2 64 bit Intel/AMD
...
***
###### Last Update 15.02.2023 05:23:14
