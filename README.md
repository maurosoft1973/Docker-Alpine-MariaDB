...
##### Alpine Version 3.17.0 (Released Feb Nov 22 2022)
...
* ```:3.17.0-10.6.11-r0``` 3.17.0-10.6.11-r0 branch based (Automatic Architecture Selection)
* ```:3.17.0-10.6.11-r0-aarch64```   3.17.0 64 bit ARM
* ```:3.17.0-10.6.11-r0-armhf```     3.17.0 32 bit ARM v6
* ```:3.17.0-10.6.11-r0-armv7```     3.17.0 32 bit ARM v7
* ```:3.17.0-10.6.11-r0-ppc64le```   3.17.0 64 bit PowerPC
* ```:3.17.0-10.6.11-r0-x86```       3.17.0 32 bit Intel/AMD
* ```:3.17.0-10.6.11-r0-x86_64```    3.17.0 64 bit Intel/AMD
...
***
###### Last Update 29.11.2022 05:25:03
