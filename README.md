...
##### Alpine Version 3.13.6 (Released Feb Aug 31 2021)
...
* ```:3.13.6-10.5.15-r0``` 3.13.6-10.5.15-r0 branch based (Automatic Architecture Selection)
* ```:3.13.6-10.5.15-r0-aarch64```   3.13.6 64 bit ARM
* ```:3.13.6-10.5.15-r0-armhf```     3.13.6 32 bit ARM v6
* ```:3.13.6-10.5.15-r0-armv7```     3.13.6 32 bit ARM v7
* ```:3.13.6-10.5.15-r0-ppc64le```   3.13.6 64 bit PowerPC
* ```:3.13.6-10.5.15-r0-x86```       3.13.6 32 bit Intel/AMD
* ```:3.13.6-10.5.15-r0-x86_64```    3.13.6 64 bit Intel/AMD
...
***
###### Last Update 21.03.2022 10:00:10
