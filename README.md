...
This Docker image [(maurosoft1973/alpine-mariadb)](https://hub.docker.com/r/maurosoft1973/alpine-mariadb/) is based on the minimal [Alpine Linux](https://alpinelinux.org/) with [MariaDB v10.6.11-r0](https://mariadb.org/) (MySQL Compatible) database server.

##### Alpine Version 3.17.1 (Released Feb Jan 09 2023)
##### MariaDB Version 10.6.11-r0
...
* ```:3.17.1-10.6.11-r0``` 3.17.1-10.6.11-r0 branch based (Automatic Architecture Selection)
* ```:3.17.1-10.6.11-r0-aarch64```   3.17.1 64 bit ARM
* ```:3.17.1-10.6.11-r0-armhf```     3.17.1 32 bit ARM v6
* ```:3.17.1-10.6.11-r0-armv7```     3.17.1 32 bit ARM v7
* ```:3.17.1-10.6.11-r0-ppc64le```   3.17.1 64 bit PowerPC
* ```:3.17.1-10.6.11-r0-x86```       3.17.1 32 bit Intel/AMD
* ```:3.17.1-10.6.11-r0-x86_64```    3.17.1 64 bit Intel/AMD
...
***
###### Last Update 15.01.2023 05:23:17
