...
##### Alpine Version 3.13.1 (Released Feb Jan 28 2021)
...
* ```:3.13.1-10.5.15-r0``` 3.13.1-10.5.15-r0 branch based (Automatic Architecture Selection)
* ```:3.13.1-10.5.15-r0-aarch64```   3.13.1 64 bit ARM
* ```:3.13.1-10.5.15-r0-armhf```     3.13.1 32 bit ARM v6
* ```:3.13.1-10.5.15-r0-armv7```     3.13.1 32 bit ARM v7
* ```:3.13.1-10.5.15-r0-ppc64le```   3.13.1 64 bit PowerPC
* ```:3.13.1-10.5.15-r0-x86```       3.13.1 32 bit Intel/AMD
* ```:3.13.1-10.5.15-r0-x86_64```    3.13.1 64 bit Intel/AMD
...
***
###### Last Update 20.03.2022 15:22:52
