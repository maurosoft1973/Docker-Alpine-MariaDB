...
This Docker image [(maurosoft1973/alpine-mariadb)](https://hub.docker.com/r/maurosoft1973/alpine-mariadb/) is based on the minimal [Alpine Linux](https://alpinelinux.org/) with [MariaDB v10.6.10-r0](https://mariadb.org/) (MySQL Compatible) database server.

##### Alpine Version 3.16.3 (Released Feb Nov 11 2022)
##### MariaDB Version 10.6.10-r0
...
* ```:3.16.3-10.6.10-r0``` 3.16.3-10.6.10-r0 branch based (Automatic Architecture Selection)
* ```:3.16.3-10.6.10-r0-aarch64```   3.16.3 64 bit ARM
* ```:3.16.3-10.6.10-r0-armhf```     3.16.3 32 bit ARM v6
* ```:3.16.3-10.6.10-r0-armv7```     3.16.3 32 bit ARM v7
* ```:3.16.3-10.6.10-r0-ppc64le```   3.16.3 64 bit PowerPC
* ```:3.16.3-10.6.10-r0-x86```       3.16.3 32 bit Intel/AMD
* ```:3.16.3-10.6.10-r0-x86_64```    3.16.3 64 bit Intel/AMD
...
***
###### Last Update 15.11.2022 05:23:40
